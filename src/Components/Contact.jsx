...
const [result, setResult] = React.useState("");
  ...
  const onSubmit = async (event) => {
    ...
    formData.append("access_key", "7d86b87c-80eb-4c94-96ca-de96ebc331bd");
...
viewport={{once:true}}
 ...
 <h1 className='text-2xl sm:text-4xl font-bold mb-2 text-center'>
        ...
        <p className='text-center text-gray-500 mb-12 max-w-80 mx-auto'>Ready to mark a move?Lets Build Your Future Together</p>
